    ...
    <aside className="h-full w-20 lg:w-72 border-r border-base-300 flex flex-col transition-all duration-200">
      <div className="border-b border-base-300 w-full p-5">
        ...
        <input
          ...
          className="input hidden lg:block input-bordered w-full pl-10"
      ...
      <div className="overflow-y-auto w-full py-3">
        {message ? (
          <p className="text-center text-zinc-500 py-4">{message}</p>
        ) : (
          (filteredSearchUsers.length > 0 ? filteredSearchUsers : filteredUsers).map((user) => (
            <button
              key={user._id}
        ...
        {!message && filteredSearchUsers.length === 0 && filteredUsers.length === 0 && (
